              ...
              <div class="sidebar-box">
                  <div class="bio text-center">
                      ...
                      <div class="bio-body">
                          ...
                          <p class="mb-4">{!! \Illuminate\Support\Str::words($post->user->description, 30)  !!}</p>
...
@section('script')
    <script>
        ...
        s.src = 'https://laravel-blog-site.disqus.com/embed.js';
        s.setAttribute('data-timestamp', +new Date());
        (d.head || d.body).appendChild(s);
        })();
    </script>
    <script id="dsq-count-scr" src="//laravel-blog-site.disqus.com/count.js" async></script>
